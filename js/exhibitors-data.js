...
// Fill in real bios and social links as they're confirmed.
//
...
var EXHIBITORS = [
  ...
  },
  {
    ...
    name: "莉山 (A)",
    bio:
      "2001年マレーシア生まれ。幼少期をイギリスで過ごし、複数の言語・文化環境の中で育つ。鑑賞者の身体的・社会的な参加によって成立する表現を探究し、インスタレーションを中心に制作している。近年は、人間同士だけではなく人間と機械の間の対話や相互作用にも関心を広げ、誤解やすれ違い、機械によって書き換えられていく記憶といったコミュニケーションの不確かさを素材として扱う。人の行動や関係性、そしてそれを分析し返してくる機械のふるまいそのものを、作品の構成要素としている。\n" +
      "\nこれまでに「『未来のえいでん』アートプロジェクト」（2025年）、「冷水機での対話 @左京区」（2026年）などのグループ展に参加。2025年「ASEAN-China Design Convergence」入選。2026年3月、「『未来のえいでん』アートプロジェクト」の参加者として2025年度京都精華大学学長表彰・学長特別賞を受賞。",
    photo:
  ...
  },
  {
    ...
    pastWorks: [
      {
        title: "Uncanny Squiggle -sketches-",
        year: "2026",
        medium: "インスタレーション",
        url: "https://youtu.be/6FBLeQ-nRIg",
      },
      {
        title: "Unreal Pareidolia -shadows-",
        year: "2023",
        medium: "インスタレーション",
        url: "https://youtu.be/PgxwIygSKUM",
      },
    ],
    social: {
